...
public class Ex0_main {
    public static Long ID0=209530583L, ID1 = 208916437L, ID2 = null;
    public static void main(String[] ar) {
        ...
        //ElevatorAlgo ex0_alg = new MyAlgo(Simulator_A.getBuilding());
        ElevatorAlgo ex0_alg = new MyAlgo2(Simulator_A.getBuilding());
